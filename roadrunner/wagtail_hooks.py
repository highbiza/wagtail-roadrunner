...
def js():
    return (roadrunner_js() +
            roadrunner_widgets_js() +
            roadrunner_colorpicker_js())
...
def urlconf_time():
    return [
        url(r"^_roadrunner/", include(roadrunner_urls, namespace="roadrunner"))
    ]
